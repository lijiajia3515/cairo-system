...
import com.hfhk.cairo.system.file.domain.util.FolderUtil;
import com.hfhk.cairo.system.service.modules.file.domain.mongo.FolderMongo;
import com.hfhk.cairo.system.service.modules.file.service.FolderService;
import com.hfhk.cairo.system.service.modules.file.service.converter.FolderConverter;
...
public class FolderServiceImpl implements FolderService {
	...
	@Override
	public Page<String> pageFind(String client, Pageable pageable, String filepath) {
		final Query query = Query.query(Criteria.where("client").is(client).and("_id").regex(filepath));
		...
		return new Page<>(pageable, paths, total);
	}
